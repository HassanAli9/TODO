...
#import "VC_inProgress.h"
#import "VC_SelectedNote.h"

@interface VC_inProgress ()
{
    NSMutableArray * arrH;
    NSMutableArray * arrM;
    NSMutableArray * arrL;
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    data = [d objectForKey:KEY_PROGRESS];
    if (data != nil) {
        ...
        [d setObject:data forKey:KEY_PROGRESS];
    }
}
    ...
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        switch (indexPath.section) {
            ...
            case 2:
                ...
                [self->d setObject:self->data forKey:KEY_PROGRESS];
...
- (IBAction)btnSortProgress:(id)sender {
    if (check == 1) {
        printf("1");
        check++;
